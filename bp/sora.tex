...
from factories and power plants, sequestering carbon emissions at the
same time.
...
order to achieve comparative advantage, accelerating the hopes of
...
the growing demand for large volumes of algae biomass. Additionally, the  algae produced also serves to satisfy the needs of other consumers of algae biomass, such as the pharmaceutical, food, cosmetic, and fertilizer industries.

In addition to large volumes of algae biomass, the product
also has the capacity to provide a sink for large volumes of \co. Thus, the product offers heavy carbon dioxide polluters an effective, reliable, and
...
more sustainable method for carbon sequestration than geologic
...
of \CCS\ is the absolute necessity of monitoring the injected sites for
...
Technology and Licensing (\textsc{otl}) is performing a prior art
...
(\textsc{pct}) which will allow for filing of international patents
within 30 months.
...
cap on biofuel from corn feedstock of 15 billion gallons per year. This
...
companies (\textit{see Appendix}) are testing laboratory methods for
biofuel creation from various biomass sources, with a special focus on
...
Though the biofuel market may be today's most promising consumer of algae, algae biomass is valuable in many other markets as well. In
...
market, some of their needs may develop more quickly than the
...
20 years. Current international carbon trade markets value this carbon anywhere from $6 to $20 per tonne, with the possiblity that new policy on carbon cap and trade will increase this value. In either case, Sora's algae farms could recycle these carbon emissions, directly benefiting power plants by disposing of excess \co, and benefiting Sora by providing a cheap source of the necessary \co.

Today over 580 coal-fired power plants exist and it is unreasonable to
expect these plants to simply disappear. Thus it is also unreasonable
to believe the environmental damage they are causing will be simply
mitigated by new sources of power. Instead, Sora believes that the
algae bioreactors can help to ease this necessary transition.
...
ethanol and biodiesel from corn and soybeans, and the growing number
of new startups centered around algae-based biofuels.
...
gasoline sold in the U.S. must contain increasing levels of ethanol in coming years.

Feedstocks such as corn and soybeans have been the simplest to employ
to meet the ethanol mandate given that the farmland and infrastructure to
...
Besides the business model, Sora's other difference major advantage is
the technology. The current competitive field can be split into
companies which use open pond systems and those which use closed
bioreactors to grow algae. While many companies use open ponds, those
using closed bioreactor systems (\textit{see Table
  \ref{tab:competitors} in the Appendixs}) experience boosts in
efficiency and control in excess of the additional material and
construction costs required for closed bioreactors.
...
Sora's target customers fall within two categories matching Sora's two
...
(\textit{see Appendix}), in addition to general analyses for the
construction and operation of a commercial installation, and a
break-even analysis.
...
million. This operation cost breakdown may be viewed in the Appendix.
...
be seen in the Appendix. It was estimated that the capital expense of a
single installation will be \$86 million.

The break-even analysis, shown in the Appendix, took the full life of
the company into consideration. The pre-pilot, pilot, and
demonstration phase costs were all included in expenditures. Revenue
streams were only generated after the commercial stage was
reached. The break-even point, the point at which the lifetime revenue
negated the lifetime expenditures, occurred after five years of
commercial operation, or after eight years of overall operation.
...
\begin{figure}[h]
  ...
  \begin{tabularx}{,95\textwidth}{l}
    \textbf{\large Annual Cash Flow Analysis}
  \end{tabularx}
  ...
  \begin{tabularx}{,45\textwidth}{ll}
    ...
    Payroll                     & \$5,000,000     \\
    Maintenance           & \$4,300,000 \\
    \hline    
    \textbf{Total} & \$32,800,000 \\
    \bottomrule
  \end{tabularx}\\[3em]
  ...
  \begin{tabularx}{,9\textwidth}{Xr}
    ...
    \toprule
    Inflow & \$52,200,000 \\
    Expenses & \textcolor{red}{\$32,800,000} \\
    \hline    
...
\begin{sidewaystable}[H]
  ...
  \begin{tabular*}{\textwidth}{p{5cm} p{7cm} p{5cm} p{2cm} p{2cm} p{2cm}}
    ...
    Internet and Phone & Marketing/networking & 1 year & --- & \$750 \\
    Hardware and Peripherals & Productivity & 5 founders & --- & \$7,500 \\
    Office space    &   Rent and utilities    & 1 year  & --- & \$15,000 \\
