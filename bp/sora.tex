...
will decrease foreign oil dependency. By striving to help our society
...
fulfills the need for an ever growing demand for large volumes of
...
algae biomass, such as the pharmaceutical, food, cosmetic, and
...
limit of only 15 billion of year produced from corn
...
pressures are making biofuels increasingly desirable and many companies (see Appendix E) are testing laboratory methods for biofuel creation from various biomass sources, with a special focus on algae. This is unsurprising as compared to other investigated biofuel feedstocks, algae has a number of distinct advantages. It is resilient to environmental changes, can be grown very quickly under ideal nutrient conditions, is being targeted by advanced genetics research to improve strains, and is one of the most carbon-negative feedstocks available.

With these planned expansions in biofuel production and consumption of feedstock, there is a great deal of room for the kind of large scale algae farm our technology supports. In order to produce the additional 21 billion gallons of biodiesel annually that must come from non-corn feedstocks, biofuel producers would require an annual supply of 140 million tonnes of algae, or the yearly output of 86 full-scale Sora installations. 
...
desirable.  In order to accommodate demand, Sora intends to create
...
\subsection{Pre-pilot Expense Breakdown}
\label{sec:pre-pilot-expense}
