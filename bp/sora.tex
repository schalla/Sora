...
\usepackage{natbib}
\usepackage{rotating}
\usepackage[left=1in,top=2.2cm,bottom=2cm]{geometry}
\usepackage{multicol}
...
\includegraphics[width=\linewidth]{masthead.png}

\vfill

Abrahamson, Joseph $\thinspace\cdot\thinspace$
Boyd, Will $\thinspace\cdot\thinspace$
Challa, Sanjay $\thinspace\cdot\thinspace$
Masuyama, Kento $\thinspace\cdot\thinspace$x
Punnoose, Andrew

\vfill

{\large \textit{Last revised}: \\
  \today}
...
qBen Hill is currently Senior Business Advisor of VentureLab, a
