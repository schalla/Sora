...
climate change. The Obama administration's \textit{Growing America's Fuels} plan hopes to produce 36 billion gallons of biofuels annually
before 2022 and is limiting the use of currently popular corn
feedstocks to just 15 billion gallons per year. The remaining 21 billion gallons per year must come from new, advanced feedstocks.
...
\subsection{Annual Cash Flow Analysis}
\label{sec:annual-cash-flow}
...
\begin{sidewaystable}
  ...
  \begin{tabular*}{\textwidth}{p{5cm} p{7cm} p{5cm} p{2cm} p{2cm} p{2cm}}
    ...
    \\
    \hlin    \textbf{Total Cost} & & & & \textbf{\$437,450} \\
    \bottomrule
    \end{tabular*}
