...
``algal blooms'' where, when not limited by resource scarcity,algae
--- one of the fastest growing organisims on the planet --- can
rapidly grow to dominate an environment. Sora plans to capitalize upon
algae's ability to reproduce exponentially in a bloom through its
carefully controlled closed bioreactor design. In this regard, Sora's
product involves a novel design targeted to increase the effective
penetration depth of incident sunlight. Furthermore, Sora's system
involves a design which significantly reduces the need for an
...
customers will be those in the biofuels industry who need large
volumes of cheap, pure algae biomass as feedstock. Our secondary
customers are power companies responsible for running \co-emitting
power plants, where Sora operates as a method to aleviate
environmental, fisal, and political pressure as a ``clean'' carbon
method. As many of these sale markets are still in their infancy, it
is expected that we will be able to enter as a major supplier in step
with their increasing needs for algae.

\subsection*{Competition}
\label{sec:exec-competition}

Sora's competitors are primarily companies producing feedstocks for
biofuels.  Our competitors can be broken down into two subgroups: corn
and soybean producers who provide a feedstock for ethanol refineries,
and algae- based biofuel startup companies. Corn and soybeans
producers have experienced tremendous growth in recent years, but
their growth will be slowed soon as a federal mandate from the Energy
Policy Act of 2005 takes effect. However, biofuels production will
continue to expand, as the Energy Act also calls for greatly increased
biofuels production while mandating that an increasing portion of
feedstock for biofuels come from other sources such as algae. As a
result, there has been an insurgence of algae-based biofuels startup
companies in the past five years, trying to both grow algae and
process it into biofuels. Our business model is fundamentally
different from other algae startups as we plan to become the dominant
producer of algae feedstock for companies with the technology and
expertise to process it into biofuels.

\subsection*{Growth Profile}
\label{sec:exec-growth}

Sora's long-term objectives are today broken down into a six month
plan and a five year plan. By ?X? we plan to develop Sora to the point
of having developed a pre-pilot installation to demonstrate and test
our technology. Additionally, we expect to have a full patent
application covering our core technology completed before ?X?. During
this time we also plan to solidify the managerial side of Sora by
completing formal arrangements with our Board of Advisors and
recruiting a CEO with experience in startups, the energy sector, and
deal negotiation.

Our five year goal is the creation of a commercial sized algae
farm. We'll achieve this by a stepped progression of technology
implementations from our 6-month pre-pilot through a pilot
installation, preferrably at a partnered power plant or industrial
plant consisting of only one or two bioreactor units by the second
year. Finally, by the 4th year we expect a demonstration low-volume
installation which will illustrate our ability to produce at the
purity, price, and volume we expect to acheive at a marketable,
commercial phase.

\subsection*{The Bottom Line}
\label{sec:exec-bottomline}

Sora expects that within the coming years, there will be an
unprededented demand for pure, cheap algae biomass. Sora plans to meet
this need with full-scale installations ready to provide algae at the
required volume and at a feasible price. Each full scale installation,
anticipated to cost X dollars and take up X acres of land, will be
capable X tons of algae per year. The produced algae can be sold at X
dollars, while operation costs at full scale will total Y
dollars. This equates to a yearly profit of Z dollars. We expect to
recover the cost of each installation within OHSOMANY years, and
continue to remain profitable for LIFEEXPECTANCYOFPLANT
years. Finally, a world with Sora is both immediately more
environmentally sustainable but also poised for a future supportive of
...
Delaware is 160 Greentree Drive, Suite 101, County of Kento, Dover, 
